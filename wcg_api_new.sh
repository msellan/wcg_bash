...
#  won't work in any Unix shell - I chose it because it's much much faster than
#  grep) to parse key/value pairs assigning only the values to a variable called
#  'value'. The construct is ${var#*SubStr} where the beginning of the string up
#  to the substring will be dropped. 
#
